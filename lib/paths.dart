class PATHS {
  ...
  static const authSignInCustomers = '${MAIN_PATH}auth_customers/login.php';
  static const conterAllTable = '${MAIN_PATH}home/home_api.php';
  // jobs
  ...
  static const viewRequestCostumer =
      '${MAIN_PATH}jobs/view_request_costumer.php';
}
